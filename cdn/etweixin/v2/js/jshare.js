...
!function (e) {
	...
	e.browser = {
		...
		wechat : -1 !== a.indexOf("MicroMessenger/index.html"),
		uc : -1 !== a.indexOf("UCBrowser"),
		qq : -1 !== a.indexOf("MQQBrowser/index.html"),
		qq1 : -1 !== a.indexOf("MQQBrowser/index.html") &&  -1 !== a.indexOf("QQ/index.html")
	},
...
(Zepto), function (e, t) {
	...
	function s() {
		...
		if (h.qq = c ? e.getVersion(navigator.appVersion.split("MQQBrowser/index.html")[1]) : 0, h.uc = l ? e.getVersion(navigator.appVersion.split("UCBrowser/index.html")[1]) : 0, c) {
